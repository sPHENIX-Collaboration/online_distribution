...
// @sa
// <O2/Detectors/ITSMFT/common/reconstruction/include/ITSMFTReconstruction/PayLoadSG.h>
//     <1c31a8d52>
...
namespace mvtx
{
  ...
  class PayLoadSG
  {
    // scatter-gather buffer for the payload: base pointer + vector of references
    // for pieces to collect
   public:
    PayLoadSG() = default;
    ~PayLoadSG() = default;
